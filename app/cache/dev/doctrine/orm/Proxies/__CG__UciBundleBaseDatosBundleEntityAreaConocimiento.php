 ...
 */
class AreaConocimiento extends \Uci\Bundle\BaseDatosBundle\Entity\AreaConocimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\AreaConocimiento' . "\0" . 'id', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\AreaConocimiento' . "\0" . 'nombreArea', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\AreaConocimiento' . "\0" . 'pmbok');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AreaConocimiento $proxy) {
