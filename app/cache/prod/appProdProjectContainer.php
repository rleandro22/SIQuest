...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'siquest', 'user' => 'SiquestUser', 'password' => 'Squst*uci@092015', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8f614234279106d1b7a8f9a0d7e5db7645788093785fe2d577bcd64a1c7beaea');
        return $instance;
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'SiquestUser',
            'database_password' => 'Squst*uci@092015',
