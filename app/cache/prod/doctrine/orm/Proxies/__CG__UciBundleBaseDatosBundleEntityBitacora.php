 ...
 */
class Bitacora extends \Uci\Bundle\BaseDatosBundle\Entity\Bitacora implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\Bitacora' . "\0" . 'id', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\Bitacora' . "\0" . 'accion', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\Bitacora' . "\0" . 'usuario');
        }
