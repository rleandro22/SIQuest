 ...
 */
class UsuarioCorrigePregunta extends \Uci\Bundle\BaseDatosBundle\Entity\UsuarioCorrigePregunta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\UsuarioCorrigePregunta' . "\0" . 'id', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\UsuarioCorrigePregunta' . "\0" . 'fechaCorreccion', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\UsuarioCorrigePregunta' . "\0" . 'comentario', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\UsuarioCorrigePregunta' . "\0" . 'pregunta', '' . "\0" . 'Uci\\Bundle\\BaseDatosBundle\\Entity\\UsuarioCorrigePregunta' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuarioCorrigePregunta $proxy) {
    ...
    public function setFechaCorreccion($fechaCorreccion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFechaCorreccion', array($fechaCorreccion));

        return parent::setFechaCorreccion($fechaCorreccion);
    }
    ...
    public function getFechaCorreccion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFechaCorreccion', array());

        return parent::getFechaCorreccion();
    }
