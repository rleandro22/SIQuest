...
class LibroController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UciBaseDatosBundle:Libro')->findAll();

        return $this->render('UciBaseDatosBundle:Libro:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UciBaseDatosBundle:Libro:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('UciBaseDatosBundle:Libro:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UciBaseDatosBundle:Libro:edit.html.twig', array(
            'entity'      => $entity,
