...
class CuestionarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UciBaseDatosBundle:Cuestionario')->findAll();

        return $this->render('UciBaseDatosBundle:Cuestionario:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UciBaseDatosBundle:Cuestionario:new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(new CuestionarioType(), $entity, array(
            'action' => $this->generateUrl('cuestionario_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UciBaseDatosBundle:Cuestionario')->find($id);
        ...
        return $this->render('UciBaseDatosBundle:Cuestionario:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UciBaseDatosBundle:Cuestionario:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new CuestionarioType(), $entity, array(
            'action' => $this->generateUrl('cuestionario_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('cuestionario_delete', array('id' => $id)))
            ->setMethod('DELETE')
