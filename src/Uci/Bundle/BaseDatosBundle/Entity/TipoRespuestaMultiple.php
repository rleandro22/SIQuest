 ...
 *
 * @ORM\Table(name="tipo_respuesta_multiple", indexes={@ORM\Index(name="fk_respuesta_multiple_respuesta1_idx", columns={"respuesta_id"})})
 * @ORM\Entity
 */
class TipoRespuestaMultiple
{
    /**
     * @var integer
     *
